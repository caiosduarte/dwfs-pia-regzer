...
var CreatePeople1623114262071 = /** @class */ (function () {
                            ...
                            checks: [
                                {
                                    name: "ck_type_person",
                                    columnNames: ["type"],
                                    expression: "type IN (" + Enum_1.enumJoinedValues(Enum_1.ALL_PERSON_TYPES) + ")",
                                },
                            ],
                        }))];
                    case 1:
    ...
    CreatePeople1623114262071.prototype.down = function (queryRunner) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    return CreatePeople1623114262071;
}());
exports.CreatePeople1623114262071 = CreatePeople1623114262071;
