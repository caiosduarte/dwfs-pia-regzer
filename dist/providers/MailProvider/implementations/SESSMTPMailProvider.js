...
var SESSMTPMailProvider = (function () {
    ...
    SESSMTPMailProvider.getInstance = function () {
        if (!SESSMTPMailProvider.INSTANCE) {
            SESSMTPMailProvider.INSTANCE = new SESSMTPMailProvider();
        }
        return SESSMTPMailProvider.INSTANCE;
    };
    SESSMTPMailProvider.prototype.sendMail = function (to, subject, variables, path) {
        return __awaiter(this, void 0, void 0, function () {
            var templateFileContent, templateParse, templateHTML, result;
    ...
    return SESSMTPMailProvider;
}());
exports.default = SESSMTPMailProvider;
